...
namespace Aldurcraft.Spellbook40.ProcessManager
{
    /// <summary>
    ...
    public class ProcessManager : IDisposable
    {
        ...
        {
            WrappedProcess = new System.Diagnostics.Process();
        ...
        public void StartProcess(string workingDir, string runFile, string arguments)
        {
            ...
            SpellbookLogger.LogInfo("Process started: " + WrappedProcess.ProcessName, this);
        }
        ...
        public bool SendInput(string command)
        {
            lock (_locker)
            {
                ...
                {
                    SpellbookLogger.LogDiag("input send failed", this, _e);
                    return false;
                }
            }
        }
        ...
        public void Dispose()
        {
            ...
            {
                SpellbookLogger.LogDiag("WrappedProcess was null, returning", this);
            ...
            catch (InvalidOperationException _e)
            {
                ...
                SpellbookLogger.LogDiag("WrappedProcess ref not tied to a real process", this, _e);
            }

            if (processExitFlag == false)
            {
                SpellbookLogger.LogDiag("Dispose failed because associated process was still running", this);
