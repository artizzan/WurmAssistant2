...
namespace WurmAssistantLauncher2.Annotations
{
  /// <summary>
  ...
  /// </summary>
  /// <example><code>
  /// [Pure] private int MultiplyEx(int x, int y) { return x * y; }
  /// public void Foo() {
  ///   const int a = 2, b = 2;
  ///   MultiplyEx(a, b); // Waring: Return value of pure method is not used
  /// }
  /// </code></example>
