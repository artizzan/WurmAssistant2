...
namespace Aldurcraft.WurmOnline.WurmAssistant2.ModuleNS.Granger
{
    public partial class FormHorseViewEdit : Form
    {
        ...
        void prepareFieldsForView()
        {
            ...
            numericUpDownAHskill.Value = (decimal)GeneralHelper.ConstrainValue<float>(horse.TraitsInspectSkill, 0F, 100F);
            ...
            comboBoxColor.Text = horse.Color.EnumVal.ToString();
            comboBoxAge.Text = horse.Age.EnumVal.ToString();
