...
namespace Aldurcraft.WurmOnline.WurmAssistant2.ModuleNS.Granger
{
    ...
    class HorseUpdatesManager
    {
        ...
        readonly GrangerDebugLogger _grangerDebug = new GrangerDebugLogger();
        ...
        internal void ProcessEventForHorseUpdates(string line)
        {
            ...
            _processor.HandleLogEvent(line);
        ...
        private class HorseData
        {
            ...
            public HorseAge Age = new HorseAge(HorseAge.Age.Unknown);
        ...
        bool EntireDbSetting
        {
            get
            {
                return _parentModule.Settings.Value.DoNotBlockDataUpdateUnlessMultiplesInEntireDb;
            }
        }
        ...
        bool HorseUpdateAnyEvent
        {
            get
            {
                return _parentModule.Settings.Value.UpdateHorseDataFromAnyEventLine;
            }
        }
