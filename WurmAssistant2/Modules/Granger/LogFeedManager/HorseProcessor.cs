...
namespace Aldurcraft.WurmOnline.WurmAssistant2.ModuleNS.Granger
{
    class HorseProcessor
    {
        ...
        class HorseBuilder
        {
            ...
            public WurmServer.ServerInfo.ServerGroup ServerGroup;
            ...
            if (_newHorse != null)
            {
                ...
                if (_verifyList.IsValid)
                {
                    ...
                    if (herdsFinds.Length == 0 &&
                        _parentModule.Settings.Value.DoNotBlockDataUpdateUnlessMultiplesInEntireDb)
                    {
                        allHerdSearch = true;
                    ...
                    if (herdsFinds.Length == 1)
                    {
                        ...
                        if (oldHorse.TraitsInspectedAtSkill.HasValue)
                        {
                            ...
                            else
                            {
                                ...
                                _parentModule.Settings.Value.RemoveGenesisCast(_newHorse.Name);
