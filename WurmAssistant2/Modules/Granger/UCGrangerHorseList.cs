    ...
    public partial class UCGrangerHorseList : UserControl
    {
        ...
        private void editToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    FormHorseViewEdit ui = new FormHorseViewEdit(MainForm, horse, Context, HorseViewEditOpType.Edit, horse.HerdAspect);
                    ui.ShowDialog();
                }
            }
        }
        ...
        private void viewToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                foreach (var horse in selected)
                {
                    FormHorseViewEdit ui = new FormHorseViewEdit(MainForm, horse, Context, HorseViewEditOpType.View, horse.HerdAspect);
                    ui.ShowDialog();
                }
            }
        }
        ...
        {
            UpdateHorsesColors(new HorseColor(HorseColor.Color.Black));
        }

        private void whiteToolStripMenuItem_Click(object sender, EventArgs e)
        {
            UpdateHorsesColors(new HorseColor(HorseColor.Color.White));
        }

        private void greyToolStripMenuItem_Click(object sender, EventArgs e)
        {
            UpdateHorsesColors(new HorseColor(HorseColor.Color.Grey));
        }

        private void brownToolStripMenuItem_Click(object sender, EventArgs e)
        {
            UpdateHorsesColors(new HorseColor(HorseColor.Color.Brown));
        }

        private void goldToolStripMenuItem_Click(object sender, EventArgs e)
        {
            UpdateHorsesColors(new HorseColor(HorseColor.Color.Gold));
        }

        private void notAHorseToolStripMenuItem_Click(object sender, EventArgs e)
        {
            UpdateHorsesColors(new HorseColor(HorseColor.Color.Unknown));
        }
        ...
        public void SaveStateToSettings()
        {
            ...
            try
            {
                MainForm.Settings.Value.HorseListState = settings;
        ...
        private void objectListView1_FormatRow(object sender, BrightIdeasSoftware.FormatRowEventArgs e)
        {
            ...
            if (color != null)
            {
                e.Item.BackColor = color.Value;
            }
            else
            {
                color = horse.BreedHintColor;
                if (color != null) e.Item.BackColor = color.Value;
            }
        }
