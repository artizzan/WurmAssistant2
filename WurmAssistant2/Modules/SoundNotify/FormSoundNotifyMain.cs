...
{
    public partial class FormSoundNotifyMain : Form
    {
        ModuleSoundNotify ParentModule;
        public FormSoundNotifyMain(ModuleSoundNotify parentModule)
        {
            this.ParentModule = parentModule;
            InitializeComponent();
            trackBarGlobalVolume.Value = 
                GeneralHelper.Validate<int>((int)(ParentModule.Settings.Value.GlobalVolume * 100), 0, 100);
            UpdateMuteIcon();
        }
        ...
        {
            ParentModule.Settings.Value.GlobalVolume = GeneralHelper.Validate<float>(
